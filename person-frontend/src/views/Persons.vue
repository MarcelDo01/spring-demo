...
export default {
  ...
  mounted () { // Life-Circle-Method = Code wird beim Neuladen ausgeführt
    ...
    fetch(endpoint, requestOptions)
      .then(response => response.json()) // Json-Repräsentation
      .then(result => result.forEach(person => {
        this.persons.push(person) // Json-Repräsentation wird auf der Konsole geloogt
      }))
